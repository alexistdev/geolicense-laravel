<x-app-layout title="Products — GeoLicense" header="Admin Console">
    <div class="p-8 space-y-6" x-data="{
                        ...
                        <tr class="hover:bg-white/5">
                            ...
                            <td class="py-3.5">
                                <div class="flex items-center justify-end gap-2">
                                    ...
                                    <button type="button" @click="openDelete({{ \Illuminate\Support\Js::from(['id' => $product->id, 'name' => $product->name]) }})"
        ...
        <div x-show="confirmOpen" x-cloak class="fixed inset-0 z-[60] flex items-center justify-center p-4" style="display:none">
